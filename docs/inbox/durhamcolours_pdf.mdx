---
title: "durhamcolours - PDF"
sidebar_label: "durhamcolours (PDF)"
sidebarLabel: "durhamcolours (PDF)"
tags: ["pdf", "document"]
---

# durhamcolours - PDF Document

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/static/inbox/durhamcolours.pdf" download="durhamcolours.pdf"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download PDF
  </a>
  <a href="/static/inbox/durhamcolours.pdf" target="_blank" rel="noopener noreferrer"
...
<div style={{padding: '12px 16px', backgroundColor: '#f3f4f6', borderRadius: '8px', display: 'inline-block', marginBottom: '24px'}}>
  <div style={{fontSize: '14px', color: '#6b7280'}}>File Size: <strong>181 KB</strong></div>
</div>
...
<iframe
  src="/static/inbox/durhamcolours.pdf"
  width="100%"
  height="900px"
  style={{
