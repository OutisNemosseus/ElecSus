...
<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/inbox/MLFittingRoutine.pdf" download="MLFittingRoutine.pdf"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download PDF
  </a>
  <a href="/inbox/MLFittingRoutine.pdf" target="_blank" rel="noopener noreferrer"
...
<iframe
  src="/inbox/MLFittingRoutine.pdf"
  width="100%"
  height="900px"
  style={{
