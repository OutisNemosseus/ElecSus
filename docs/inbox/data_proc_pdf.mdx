...
<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/static/inbox/data_proc.pdf" download="data_proc.pdf"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download PDF
  </a>
  <a href="/static/inbox/data_proc.pdf" target="_blank" rel="noopener noreferrer"
...
<iframe
  src="/static/inbox/data_proc.pdf"
  width="100%"
  height="900px"
  style={{
